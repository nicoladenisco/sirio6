...
/**
 * CORREGGE UN ERRORE DI TurbinePullService.
 * Vedi metodo populateContext.
 * <br>
 * <br>
 ...
 * @version $Id$
 */
public class EffectiveTurbinePullService
   extends TurbineBaseService
   implements PullService
{
  /** Logging */
  private static Logger log = LogManager.getLogger(EffectiveTurbinePullService.class);
  ...
  /** il refresh lo passiamo a true per default */
     ...
     throws InitializationException
  {
    ...
    {
      throw new InitializationException("EffectiveTurbinePullService failed to initialize", e);
    }
  }
     ...
     throws Exception
  {
    ...
    // request basis.
    refreshToolsPerRequest = conf.getBoolean(
  ...
  public void populateContext(Context context, RunData data)
  {
    ...
    if(user != null)
    {
      ...
      TurbineUserManager userManager = (TurbineUserManager) TurbineServices
         .getInstance()
